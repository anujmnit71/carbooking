...
public class BookingControllerAdvice {
    ...
    public ResponseEntity<Object> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        HttpError apiError = new HttpError(HttpStatus.BAD_REQUEST, ex.getLocalizedMessage(), errors);
    ...
    public ResponseEntity<Object> handlePSQLException(PSQLException ex) {
        ...
        HttpError apiError = new HttpError(httpStatus, ex.getMessage(), String.format("PostgreSQL error code %s",
                ex.getSQLState()));
        return new ResponseEntity<>(apiError, new HttpHeaders(), apiError.getStatus());
    }
